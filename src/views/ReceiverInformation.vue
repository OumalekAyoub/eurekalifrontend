                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="form7Example1" class="form-control" placeholder="Number"
                                                v-model="number">
                                        </div>
                                    </div>
                                    <div class="col">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <template v-if="$store.state.shipment.receiver">
                                    <li class="list-group-item d-flex  align-items-center border-0 px-0 pb-0">
                                        <router-link to="/receiver_information" class="link-success"><i class="fa fa-check"
                                                aria-hidden="true" style="margin-right: 5px;"></i> Receiver
                                            Information</router-link>
                                    </li>
                                </template>
                                <template v-else>
                                    <li class="list-group-item d-flex  align-items-center border-0 px-0 pb-0">
                                        <router-link to="/receiver_information" class="link-secondary"> Receiver
                                            Information</router-link>
                                    </li>
                                </template>
                            ...
                            <template
                                v-if="number && street && postal_code && city && state && email && phone && first_name && last_name">
...
export default {
    ...
    mounted() {
        document.title = 'Receiver Information | Eurekali'
        ...
        this.number = this.$store.state.shipment.receiver.number
        this.street = this.$store.state.shipment.receiver.street
        this.postal_code = this.$store.state.shipment.receiver.postal_code
        this.city = this.$store.state.shipment.receiver.city
        this.state = this.$store.state.shipment.receiver.state
        this.email = this.$store.state.shipment.receiver.email
        this.phone = this.$store.state.shipment.receiver.phone
        this.first_name = this.$store.state.shipment.receiver.first_name
        this.last_name = this.$store.state.shipment.receiver.last_name
    },
    methods: {
        checkFields() {
            if (!this.first_name) {
        ...
        async checkPostalcode() {
            if (!this.email) {
                ...
                if (!emailRegex.test(this.email)) {
                    ...
                    await axios.get(`/api/v1/postal_code/${this.new_country}/${this.postal_code}`)
                        .then(response => {
        ...
        setReceiver() {
            ...
            const country = this.new_country
